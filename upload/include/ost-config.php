...
define('SECRET_SALT','OXxhnKFkbqbJ6WJ20KTgk06OD4fUbHwD');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','humberto.moya@concordiabh.com');
...
define('DBNAME','os_ticket');
define('DBUSER','os_ticket');
define('DBPASS','os_ticket');
